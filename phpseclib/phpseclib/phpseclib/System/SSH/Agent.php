 ...
 *
 *    $agent = new \phpseclibnzr3\System\SSH\Agent();
 *
...
namespace phpseclibnzr3\System\SSH;
...
use phpseclibnzr3\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \phpseclibnzr3\System\SSH\Agent\Identity objects
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  public
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \phpseclibnzr3\System\SSH\Agent
     * @throws \phpseclibnzr3\Exception\BadConfigurationException if SSH_AUTH_SOCK cannot be found
     ...
     * Returns an array containing zero or more \phpseclibnzr3\System\SSH\Agent\Identity objects
     *
     * @return array
     ...
     *
     * @param \phpseclibnzr3\Net\SSH2 $ssh
     * @return bool
     * @access private
     */
