...
namespace phpseclibnzr3\System\SSH\Agent;
 ...
 *
 * Instantiation should only be performed by \phpseclibnzr3\System\SSH\Agent class.
 * This could be thought of as implementing an interface that phpseclibnzr3\Crypt\RSA
...
{
    use \phpseclibnzr3\System\SSH\Common\Traits\ReadBytes;
     ...
     * Set Public Key
     *
     * Called by \phpseclibnzr3\System\SSH\Agent::requestIdentities()
     *
     * @param \phpseclibnzr3\Crypt\Common\PublicKey $key
     * @access private
     */
     ...
     * Set Public Key
     *
     * Called by \phpseclibnzr3\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
