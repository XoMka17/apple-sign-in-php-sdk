...
namespace phpseclibnzr3\Common\Functions;

use phpseclibnzr3\Math\BigInteger;
use phpseclibnzr3\Math\Common\FiniteField;
            ...
            switch ($format[$i]) {
                ...
                case 'i':
                    if (!$element instanceof BigInteger && !$element instanceof FiniteField\Integer) {
                        throw new \InvalidArgumentException('A phpseclibnzr3\Math\BigInteger or phpseclibnzr3\Math\Common\FiniteField\Integer object was expected.');
                    }
