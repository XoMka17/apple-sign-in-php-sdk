...
namespace phpseclibnzr3\Crypt\EC\Formats\Keys;

use ParagonIE\ConstantTime\Base64;
use phpseclibnzr3\Common\Functions\Strings;
use phpseclibnzr3\Crypt\EC\BaseCurves\Base as BaseCurve;
use phpseclibnzr3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use phpseclibnzr3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use phpseclibnzr3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use phpseclibnzr3\Exception\BadConfigurationException;
...
abstract class XML
{
     ...
     *
     * @param \DOMXPath $xpath
     * @param \phpseclibnzr3\Crypt\EC\BaseCurves\Base $curve
     * @return object[]
     */
    ...
    /**
     * Returns an instance of \phpseclibnzr3\Crypt\EC\BaseCurves\Base based
     * on the curve parameters
     *
     * @param \DomXPath $xpath
     * @return \phpseclibnzr3\Crypt\EC\BaseCurves\Base|false
     */
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\phpseclibnzr3\Crypt\EC\Curves\\' . $name;
     ...
     *
     * @param \phpseclibnzr3\Crypt\EC\BaseCurves\Base $curve
     * @param \phpseclibnzr3\Math\Common\FiniteField\Integer[] $publicKey
