...
use phpseclibnzr3\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
...
abstract class OpenSSH extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if ($parsed['type'] == 'ssh-ed25519') {
            ...
            $curveName = '\phpseclibnzr3\Crypt\EC\Curves\\' . $curveName;
            $curve = new $curveName();
     ...
     * @param \phpseclibnzr3\Crypt\EC\Curves\Ed25519 $curve
     * @param \phpseclibnzr3\Math\Common\FiniteField\Integer[] $publicKey
     * @param string $password optional
     * @param array $options optional
     * @return string
