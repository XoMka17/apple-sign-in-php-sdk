 ...
 *
 * $private = \phpseclibnzr3\Crypt\DSA::createKey();
...
use phpseclibnzr3\Crypt\DSA\Parameters;
use phpseclibnzr3\Crypt\DSA\PrivateKey;
use phpseclibnzr3\Crypt\DSA\PublicKey;
...
abstract class DSA extends AsymmetricKey
{
     ...
     * @param int $L
     * @param int $N
     * @return \phpseclibnzr3\Crypt\DSA|bool
     */
