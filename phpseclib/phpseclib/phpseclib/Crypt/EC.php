 ...
 *
 * $private = \phpseclibnzr3\Crypt\EC::createKey('secp256k1');
...
use phpseclibnzr3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use phpseclibnzr3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use phpseclibnzr3\Crypt\EC\Curves\Curve25519;
use phpseclibnzr3\Crypt\EC\Curves\Ed25519;
use phpseclibnzr3\Crypt\EC\Curves\Ed448;
use phpseclibnzr3\Crypt\EC\Formats\Keys\PKCS1;
use phpseclibnzr3\Crypt\EC\Parameters;
use phpseclibnzr3\Crypt\EC\PrivateKey;
use phpseclibnzr3\Crypt\EC\PublicKey;
use phpseclibnzr3\Exception\UnsupportedAlgorithmException;
use phpseclibnzr3\Exception\UnsupportedCurveException;
use phpseclibnzr3\Exception\UnsupportedOperationException;
use phpseclibnzr3\File\ASN1;
use phpseclibnzr3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
     ...
     * Curve
     *
     * @var \phpseclibnzr3\Crypt\EC\BaseCurves\Base
     */
    protected $curve;
     ...
     *
     * @var \phpseclibnzr3\Math\BigInteger
     */
    protected $q;
     ...
     * @access public
     * @param string $curve
     * @return \phpseclibnzr3\Crypt\EC\PrivateKey
     */
    public static function createKey($curve)
    {
        ...
        $curve = '\phpseclibnzr3\Crypt\EC\Curves\\' . $curveName;
