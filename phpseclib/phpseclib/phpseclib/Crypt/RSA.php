 ...
 *
 * $private = \phpseclibnzr3\Crypt\RSA::createKey();
...
use phpseclibnzr3\Crypt\RSA\PrivateKey;
use phpseclibnzr3\Crypt\RSA\PublicKey;
...
abstract class RSA extends AsymmetricKey
{
     ...
     *
     * @access private
     * @param bool|\phpseclibnzr3\Math\BigInteger $x
     * @param int $xLen
     * @return bool|string
     */
     ...
     * @access private
     * @param string $x
     * @return \phpseclibnzr3\Math\BigInteger
     */
    ...
    public function withHash($hash)
    {
        ...
        // \phpseclibnzr3\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
