 ...
 *
 *    $des = new \phpseclibnzr3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends BlockCipher
{
     ...
     * @see \phpseclibnzr3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
     ...
     *
     * @see \phpseclibnzr3\Crypt\Common\SymmetricKey::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \phpseclibnzr3\Crypt\Common\SymmetricKey::isValidEngine()
     * @param int $engine
     * @access protected
     * @return bool
     */
