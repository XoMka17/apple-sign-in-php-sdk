...
namespace phpseclibnzr3\Crypt\RSA;
...
use phpseclibnzr3\Exception\UnsupportedFormatException;
use phpseclibnzr3\File\ASN1;
use phpseclibnzr3\File\ASN1\Maps\DigestInfo;
...
class PublicKey extends RSA implements Common\PublicKey
{
     ...
     * Exponentiate
     *
     * @param \phpseclibnzr3\Math\BigInteger $x
     ...
     *
     * @access private
     * @param \phpseclibnzr3\Math\BigInteger $s
     * @return bool|\phpseclibnzr3\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \phpseclibnzr3\Math\BigInteger $m
     * @return bool|\phpseclibnzr3\Math\BigInteger
     */
