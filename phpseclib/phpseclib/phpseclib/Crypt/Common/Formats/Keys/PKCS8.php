...
namespace phpseclibnzr3\Crypt\Common\Formats\Keys;

use ParagonIE\ConstantTime\Base64;
use phpseclibnzr3\Common\Functions\Strings;
use phpseclibnzr3\Crypt\AES;
use phpseclibnzr3\Crypt\DES;
use phpseclibnzr3\Crypt\Random;
use phpseclibnzr3\Crypt\RC2;
use phpseclibnzr3\Crypt\RC4;
use phpseclibnzr3\Crypt\TripleDES;
...
abstract class PKCS8 extends PKCS
{
     ...
     *
     * @return \phpseclibnzr3\Crypt\Common\SymmetricKey
     * @access public
     * @param string $algo
     */
