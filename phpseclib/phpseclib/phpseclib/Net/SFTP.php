 ...
 *
 *    $sftp = new \phpseclibnzr3\Net\SFTP('www.domain.tld');
...
use phpseclibnzr3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * \phpseclibnzr3\Net\SSH2::exec() uses 0 and \phpseclibnzr3\Net\SSH2::read() / \phpseclibnzr3\Net\SSH2::write() use 1.
     *
     ...
     *
     * @access public
     * @see \phpseclibnzr3\Net\SFTP::put()
     */
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // the order, in this case, matters quite a lot - see \phpseclibnzr3\Net\SFTP::_parseAttributes() to understand why
        $this->attributes = [
        ...
        // see \phpseclibnzr3\Net\SFTP::_parseLongname() for an explanation
        $this->file_types = [
    ...
    private function init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \phpseclibnzr3\Net\SFTP would do is close the
    ...
    public function chdir($dir)
    {
        ...
        // see \phpseclibnzr3\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \phpseclibnzr3\Net\SFTP::realpath().
     ...
     *
     * By default, \phpseclibnzr3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \phpseclibnzr3\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     *
     * {@internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \phpseclibnzr3\Net\SFTP::setMode().}
     *
     ...
     * @throws \phpseclibnzr3\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     * @access public
     */
