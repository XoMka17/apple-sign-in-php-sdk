 ...
 *
 *    $ssh = new \phpseclibnzr3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \phpseclibnzr3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \phpseclibnzr3\Net\SSH2('www.domain.tld');
...
namespace phpseclibnzr3\Net;

use phpseclibnzr3\Common\Functions\Strings;
use phpseclibnzr3\Crypt\Blowfish;
use phpseclibnzr3\Crypt\ChaCha20;
use phpseclibnzr3\Crypt\Common\AsymmetricKey;
use phpseclibnzr3\Crypt\Common\PrivateKey;
use phpseclibnzr3\Crypt\Common\PublicKey;
use phpseclibnzr3\Crypt\Common\SymmetricKey;
use phpseclibnzr3\Crypt\DH;
use phpseclibnzr3\Crypt\DSA;
use phpseclibnzr3\Crypt\EC;
use phpseclibnzr3\Crypt\Hash;
use phpseclibnzr3\Crypt\Random;
use phpseclibnzr3\Crypt\RC4;
use phpseclibnzr3\Crypt\Rijndael;
use phpseclibnzr3\Crypt\RSA;
use phpseclibnzr3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use phpseclibnzr3\Crypt\Twofish;
use phpseclibnzr3\Exception\ConnectionClosedException;
use phpseclibnzr3\Exception\InsufficientSetupException;
use phpseclibnzr3\Exception\NoSupportedAlgorithmsException;
use phpseclibnzr3\Exception\UnableToConnectException;
use phpseclibnzr3\Exception\UnsupportedAlgorithmException;
use phpseclibnzr3\Exception\UnsupportedCurveException;
use phpseclibnzr3\Math\BigInteger;
use phpseclibnzr3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \phpseclibnzr3\Net\SSH2::send_channel_packet()
     * @see \phpseclibnzr3\Net\SSH2::get_channel_packet()
     * @access private
     */
     ...
     *
     * @access public
     * @see \phpseclibnzr3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @access public
     * @see \phpseclibnzr3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \phpseclibnzr3\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     * @access private
     */
     ...
     * \phpseclibnzr3\Crypt\Common\SymmetricKey.
     *
     * @param string $algorithm Name of the encryption algorithm
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \phpseclibnzr3\Crypt\RSA|EC|DSA object, a \phpseclibnzr3\System\SSH\Agent object or an array
     *
        ...
        foreach ($args as $arg) {
            switch (true) {
                ...
                case Strings::is_stringable($arg):
                    break;
                default:
                    throw new \UnexpectedValueException('$password needs to either be an instance of \phpseclibnzr3\Crypt\Common\PrivateKey, \System\SSH\Agent, an array or a string');
            }
        }
     ...
     *
     * @param string $username
     * @param \phpseclibnzr3\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \phpseclibnzr3\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     * @access private
     */
        ...
        if ($publickey instanceof RSA) {
            ...
            switch ($curveName) {
                ...
                default:
                    ...
                    throw new UnsupportedCurveException('Named Curve of ' . $curveName . ' is not supported by phpseclibnzr3\'s SSH2 implementation');
            }
     ...
     * Execute Command
     *
     * If $callback is set to false then \phpseclibnzr3\Net\SSH2::get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    public function exec($command, callable $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \phpseclibnzr3\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \phpseclibnzr3\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
     ...
     * @throws \phpseclibnzr3\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     * @access public
     */
