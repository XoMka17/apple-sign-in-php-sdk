 ...
 * <code>
 * <?php
 *    $a = new \phpseclibnzr3\Math\BigInteger(2);
 *    $b = new \phpseclibnzr3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace phpseclibnzr3\Math;

use phpseclibnzr3\Exception\BadConfigurationException;
use phpseclibnzr3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'phpseclibnzr3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \phpseclibnzr3\Math\BigInteger('10');
     *    $b = new \phpseclibnzr3\Math\BigInteger('20');
     *
